...
//        [imageView addGestureRecognizer:singleTap];
    ...
    if (scrollDirection == CycleDirectionLandscape) {
        [scrollView setContentOffset:CGPointMake(scrollFrame.size.width, 0) animated:NO];
    }
    if (scrollDirection == CycleDirectionPortait) {
        [scrollView setContentOffset:CGPointMake(0, scrollFrame.size.height) animated:NO];
    }
}
...
-(void)startTimer{
    myTimer = [NSTimer scheduledTimerWithTimeInterval:timerDuration
                                                    target:self
...
//- (void)tapDetectingImageView:(TapDetectingImageView *)view beginSingleTapAtPoint:(CGPoint)tapPoint{
//    [self stopTimer];
//}
//- (void)tapDetectingImageView:(TapDetectingImageView *)view endSingleTapAtPoint:(CGPoint)tapPoint{
